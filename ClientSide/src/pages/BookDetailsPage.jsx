    ...
    const fetchBookData = async () => {
      ...
      try {
        ...
        setBookData({
          ...
          stockStatus:
            book.stockQty > 0
              ? `In Stock (${book.stockQty} copies)`
              : "Out of Stock",
          libraryStatus:
            book.stockQty > 0
              ? "Available for in-store reading"
              : "Not Available",
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center mb-8 text-sm">
              <div className="mr-6 flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${
                    bookData.stockStatus.includes("In Stock")
                      ? "bg-green-500"
                      : "bg-yellow-500"
                  }`}
                ></div>
              ...
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full mr-2 ${
                    bookData.libraryStatus.includes("Available")
                      ? "bg-green-500"
                      : "bg-yellow-500"
                  }`}
                ></div>
            ...
            <div className="flex items-center space-x-3 mb-8">
              ...
              <button
                onClick={() => {
                  handleAddToFavorites(bookData.id);
                  setIsWishlisted(!isWishlisted);
                }}
                className={`p-2 rounded-md ${
                  favoriteIds.includes(bookData.id)
              ...
              >
                <Heart
                  size={20}
                  className={
                    favoriteIds.includes(bookData.id) ? "fill-red-500" : ""
                  }
                />
              </button>
            </div>
                      ...
                      <ul className="list-disc list-inside text-gray-700">
                        {bookData.awards.map((award) => (
                          <li key={award} className="flex items-start mb-1">
                            <Award
                              size={16}
                              className="mr-2 mt-1 text-yellow-500 flex-shrink-0"
                            />
                            <span>{award}</span>
                          </li>
                        ))}
                  ...
                  <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="text-sm text-gray-700">
                      <p className="mb-2">
                        ...
                        After placing your order online, you'll receive a
                        confirmation email with a claim code.
                      </p>
                      <p className="mb-2">
                        <span className="font-medium">Pick-up:</span> Visit our
                        store with your membership ID and claim code to complete
                        your purchase.
                      </p>
                      <p>
                        <span className="font-medium">Discounts:</span> Orders
                        of 5+ books receive a 5% discount. After every 10
                        successful orders, earn a 10% stackable discount!
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    {bookData.reviews.map((review, index) => (
                      <div
                        ...
                        className={`mb-6 flex items-start ${
                          index < bookData.reviews.length - 1
