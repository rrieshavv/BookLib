...
namespace BookLib.Migrations
{
    ...
    [Migration("20250512034644_fields_Added_to_inventory")]
    partial class fields_Added_to_inventory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.ApiAccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.ErrorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.Inventory", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("company_reg_no")
                        .IsRequired()
                        .HasMaxLength(20)
                    ...
                    b.Property<decimal>("price_per_book")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)");
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.Reviews", b =>
                {
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.Inventory", b =>
                {
                    b.HasOne("BookLib.Infrastructure.Data.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("book_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookLib.Infrastructure.Data.Entities.Invoice", b =>
                {
                    b.HasOne("BookLib.Infrastructure.Data.Entities.Order", "Order")
                        .WithOne("Invoice")
                        .HasForeignKey("BookLib.Infrastructure.Data.Entities.Invoice", "invoice_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
